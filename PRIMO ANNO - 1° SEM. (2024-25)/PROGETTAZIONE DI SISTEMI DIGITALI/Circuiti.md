In un sistema digitale, un **circuito** è, in sostanza, una rete che processa determinate variabili e ne restituisce altre. In questo senso, un circuito generico avrà le seguenti caratteristiche fondamentali:
- uno o più **input**;
- uno o più **output**;
